...
drv<-JDBC(driverClass = "org.mariadb.jdbc.Driver", classPath = "C:/pwork/mariadb-java-client-2.6.2.jar")
...
summary(model)  # p-value: 6.943e-13 < 0.05 유의한 모델. R-squared:  0.8458(정확도라는 말X)
